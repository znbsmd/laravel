        ...
        <div class="col-sm-8 blog-main">
            <div class="blog-post">
                <div style="display:inline-flex">
                    <h2 class="blog-post-title">{{$articleList->title}}</h2>
                    <a style="margin: auto"  href="/article/edit/{{$articleList->id}}">
                        <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                    </a>
                    <a style="margin: auto"  href="/article/delete/{{$articleList->id}}">
                ...
                <p><p>{!!$articleList->content!!}</p><p><br></p></p>
                <div>
